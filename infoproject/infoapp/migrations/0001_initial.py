...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='SubstationFeeder',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('substation_name', models.CharField(blank=True, max_length=20, null=True)),
                ('feeder_no', models.CharField(blank=True, max_length=20, null=True)),
                ('no_of_consummer', models.CharField(blank=True, max_length=20, null=True)),
                ('pbs_code', models.CharField(blank=True, max_length=100, null=True)),
            ],
        ),
        migrations.CreateModel(
